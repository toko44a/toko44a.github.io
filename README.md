...
The content of the Product page can be changed here:`/product.html`
...
```
#####Project post
Create a Project post to go in your Product by creating a file called `yyyy-mm-dd-name-of-the-project.markdown` in the `/_posts/project/` directory with the following template:
```markdown
---
...
img: product_10.jpg #place image (600x450) with this name in /assets/img/project/
thumb: thumb02.jpg
carousel:
